...
type CreatePropertySaudiMobileFieldProps = {
  label: string;
  placeholder: string;
  value: string;
...
export default function CreatePropertySaudiMobileField({
  label,
  placeholder,
  value,
  onChange,
  ...
  invalid = false,
  valid = false,
}: CreatePropertySaudiMobileFieldProps) {
  const inputId = useId();
    ...
    <div>
      ...
      >
        ...
        <Input
          ...
          dir="ltr"
          inputMode="tel"
          // No native maxLength: pasted international forms (+966 5x xxx xxxx) are
          // longer than 10 chars and would be truncated before normalization.
          value={value}
          onChange={(event) => {
